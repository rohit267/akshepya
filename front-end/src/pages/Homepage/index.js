...
let dummyQuestions = [{
    ...
    "commenters": ["https://robohash.org/dictaaccusamusvoluptates.png?size=50x50&set=set1", "https://robohash.org/dictaaccusamusvoluptates.png?size=50x50&set=set1"],
    "noOfComments": 1,
    "views": 2577,
    "timeAgo": "1:44 AM"
}, {
    ...
    "commenters": ["https://robohash.org/distinctionostrumplaceat.png?size=50x50&set=set1", "https://robohash.org/dictaaccusamusvoluptates.png?size=50x50&set=set1"],
    "noOfComments": 2,
    "views": 3134,
    "timeAgo": "7:08 AM"
}, {
    ...
    "commenters": ["https://robohash.org/etnobisdebitis.png?size=50x50&set=set1", "https://robohash.org/distinctionostrumplaceat.png?size=50x50&set=set1"],
    "noOfComments": 7,
    "views": 3476,
    "timeAgo": "4:09 AM"
}, {
    ...
    "commenters": ["https://robohash.org/doloribusiustocupiditate.png?size=50x50&set=set1"],
    "noOfComments": 9,
    "views": 1862,
    "timeAgo": "1:49 PM"
}, {
    ...
    "commenters": ["https://robohash.org/porrocumquenumquam.png?size=50x50&set=set1", "https://robohash.org/distinctionostrumplaceat.png?size=50x50&set=set1"],
    "noOfComments": 10,
    "views": 3107,
    "timeAgo": "3:23 PM"
}, {
    ...
    "commenters": ["https://robohash.org/quisinventoreconsequatur.png?size=50x50&set=set1"],
    "noOfComments": 6,
    "views": 4214,
    "timeAgo": "7:00 AM"
}, {
    ...
    "commenters": ["https://robohash.org/ipsametnulla.png?size=50x50&set=set1", "https://robohash.org/distinctionostrumplaceat.png?size=50x50&set=set1"],
    "noOfComments": 1,
    "views": 99,
    "timeAgo": "3:18 PM"
}, {
    ...
    "commenters": ["https://robohash.org/estillovoluptates.png?size=50x50&set=set1"],
    "noOfComments": 4,
    "views": 1634,
    "timeAgo": "7:25 PM"
}]
            ...
            <Container maxW="container.lg">
                <Box p='8px' borderBottom='1px solid #aadbe2' display='flex' justifyContent='space-between' overflow='auto'>
                    <Box display='inline' minWidth='250px' maxWidth='600px'>
                        <Text cursor='pointer' fontSize='18px' fontWeight='semibold'>Topic</Text>
                    </Box>
                    <Spacer />
                    <Flex w='160px'>
                        <Box>
